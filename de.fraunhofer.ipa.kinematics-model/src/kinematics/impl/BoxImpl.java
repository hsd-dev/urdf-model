 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.BoxImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoxImpl extends MinimalEObjectImpl.Container implements Box {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.BOX;
	}
	...
	public void setSize(String newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.BOX__SIZE, oldSize, size, !oldSizeESet));
	}
	...
	public void unsetSize() {
		...
		sizeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.BOX__SIZE, oldSize, SIZE_EDEFAULT, oldSizeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.BOX__SIZE:
				return getSize();
		}
