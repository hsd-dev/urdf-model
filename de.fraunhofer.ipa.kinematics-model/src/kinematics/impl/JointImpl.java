 ...
 *   <li>{@link kinematics.impl.JointImpl#getCalibration <em>Calibration</em>}</li>
 *   <li>{@link kinematics.impl.JointImpl#getDynamics <em>Dynamics</em>}</li>
 *   <li>{@link kinematics.impl.JointImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link kinematics.impl.JointImpl#getSafetyController <em>Safety Controller</em>}</li>
 *   <li>{@link kinematics.impl.JointImpl#getMimic <em>Mimic</em>}</li>
...
public class JointImpl extends MinimalEObjectImpl.Container implements Joint {
	...
	public NotificationChain basicSetParent(Parent newParent, NotificationChain msgs) {
		...
		parent = newParent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__PARENT, oldParent, newParent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParent(Parent newParent) {
		if (newParent != parent) {
			NotificationChain msgs = null;
			if (parent != null)
				msgs = ((InternalEObject)parent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__PARENT, null, msgs);
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__PARENT, null, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__PARENT, newParent, newParent));
	}
	...
	public NotificationChain basicSetChild(Child newChild, NotificationChain msgs) {
		...
		child = newChild;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__CHILD, oldChild, newChild);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChild(Child newChild) {
		if (newChild != child) {
			NotificationChain msgs = null;
			if (child != null)
				msgs = ((InternalEObject)child).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__CHILD, null, msgs);
			if (newChild != null)
				msgs = ((InternalEObject)newChild).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__CHILD, null, msgs);
			msgs = basicSetChild(newChild, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__CHILD, newChild, newChild));
	}
	...
	public NotificationChain basicSetCalibration(Calibration newCalibration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__CALIBRATION, oldCalibration, newCalibration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalibration(Calibration newCalibration) {
		if (newCalibration != calibration) {
			NotificationChain msgs = null;
			if (calibration != null)
				msgs = ((InternalEObject)calibration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__CALIBRATION, null, msgs);
			if (newCalibration != null)
				msgs = ((InternalEObject)newCalibration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__CALIBRATION, null, msgs);
			msgs = basicSetCalibration(newCalibration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__CALIBRATION, newCalibration, newCalibration));
	}
	...
	public NotificationChain basicSetDynamics(Dynamics newDynamics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__DYNAMICS, oldDynamics, newDynamics);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDynamics(Dynamics newDynamics) {
		if (newDynamics != dynamics) {
			NotificationChain msgs = null;
			if (dynamics != null)
				msgs = ((InternalEObject)dynamics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__DYNAMICS, null, msgs);
			if (newDynamics != null)
				msgs = ((InternalEObject)newDynamics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__DYNAMICS, null, msgs);
			msgs = basicSetDynamics(newDynamics, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__DYNAMICS, newDynamics, newDynamics));
	}
	...
	public NotificationChain basicSetSafetyController(SafetyController newSafetyController, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__SAFETY_CONTROLLER, oldSafetyController, newSafetyController);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSafetyController(SafetyController newSafetyController) {
		if (newSafetyController != safetyController) {
			...
			if (safetyController != null)
				msgs = ((InternalEObject)safetyController).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__SAFETY_CONTROLLER, null, msgs);
			if (newSafetyController != null)
				msgs = ((InternalEObject)newSafetyController).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__SAFETY_CONTROLLER, null, msgs);
			msgs = basicSetSafetyController(newSafetyController, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__SAFETY_CONTROLLER, newSafetyController, newSafetyController));
	}
	...
	public NotificationChain basicSetMimic(Mimic newMimic, NotificationChain msgs) {
		...
		mimic = newMimic;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__MIMIC, oldMimic, newMimic);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMimic(Mimic newMimic) {
		if (newMimic != mimic) {
			NotificationChain msgs = null;
			if (mimic != null)
				msgs = ((InternalEObject)mimic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__MIMIC, null, msgs);
			if (newMimic != null)
				msgs = ((InternalEObject)newMimic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KinematicsPackage.JOINT__MIMIC, null, msgs);
			msgs = basicSetMimic(newMimic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.JOINT__MIMIC, newMimic, newMimic));
	}
