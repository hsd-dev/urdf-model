 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.MimicImpl#getJoint <em>Joint</em>}</li>
 *   <li>{@link kinematics.impl.MimicImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link kinematics.impl.MimicImpl#getOffset <em>Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MimicImpl extends MinimalEObjectImpl.Container implements Mimic {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.MIMIC;
	}
	...
	public void setJoint(String newJoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.MIMIC__JOINT, oldJoint, joint));
	}
	...
	public void setMultiplier(double newMultiplier) {
		...
		multiplierESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.MIMIC__MULTIPLIER, oldMultiplier, multiplier, !oldMultiplierESet));
	}
	...
	public void unsetMultiplier() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.MIMIC__MULTIPLIER, oldMultiplier, MULTIPLIER_EDEFAULT, oldMultiplierESet));
	}
	...
	public void setOffset(double newOffset) {
		...
		offsetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.MIMIC__OFFSET, oldOffset, offset, !oldOffsetESet));
	}
	...
	public void unsetOffset() {
		...
		offsetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.MIMIC__OFFSET, oldOffset, OFFSET_EDEFAULT, oldOffsetESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.MIMIC__JOINT:
				return getJoint();
			case KinematicsPackage.MIMIC__MULTIPLIER:
				return getMultiplier();
			case KinematicsPackage.MIMIC__OFFSET:
				return getOffset();
		}
