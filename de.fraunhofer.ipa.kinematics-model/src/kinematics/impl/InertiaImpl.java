 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.InertiaImpl#getIxx <em>Ixx</em>}</li>
 *   <li>{@link kinematics.impl.InertiaImpl#getIxy <em>Ixy</em>}</li>
 *   <li>{@link kinematics.impl.InertiaImpl#getIxz <em>Ixz</em>}</li>
 *   <li>{@link kinematics.impl.InertiaImpl#getIyy <em>Iyy</em>}</li>
 *   <li>{@link kinematics.impl.InertiaImpl#getIyz <em>Iyz</em>}</li>
 *   <li>{@link kinematics.impl.InertiaImpl#getIzz <em>Izz</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InertiaImpl extends MinimalEObjectImpl.Container implements Inertia {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.INERTIA;
	}
	...
	public void setIxx(double newIxx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IXX, oldIxx, ixx, !oldIxxESet));
	}
	...
	public void unsetIxx() {
		...
		ixxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IXX, oldIxx, IXX_EDEFAULT, oldIxxESet));
	}
	...
	public void setIxy(double newIxy) {
		...
		ixyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IXY, oldIxy, ixy, !oldIxyESet));
	}
	...
	public void unsetIxy() {
		...
		ixyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IXY, oldIxy, IXY_EDEFAULT, oldIxyESet));
	}
	...
	public void setIxz(double newIxz) {
		...
		ixzESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IXZ, oldIxz, ixz, !oldIxzESet));
	}
	...
	public void unsetIxz() {
		...
		ixzESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IXZ, oldIxz, IXZ_EDEFAULT, oldIxzESet));
	}
	...
	public void setIyy(double newIyy) {
		...
		iyyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IYY, oldIyy, iyy, !oldIyyESet));
	}
	...
	public void unsetIyy() {
		...
		iyyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IYY, oldIyy, IYY_EDEFAULT, oldIyyESet));
	}
	...
	public void setIyz(double newIyz) {
		...
		iyzESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IYZ, oldIyz, iyz, !oldIyzESet));
	}
	...
	public void unsetIyz() {
		...
		iyzESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IYZ, oldIyz, IYZ_EDEFAULT, oldIyzESet));
	}
	...
	public void setIzz(double newIzz) {
		...
		izzESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.INERTIA__IZZ, oldIzz, izz, !oldIzzESet));
	}
	...
	public void unsetIzz() {
		...
		izzESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.INERTIA__IZZ, oldIzz, IZZ_EDEFAULT, oldIzzESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.INERTIA__IXX:
				return getIxx();
			case KinematicsPackage.INERTIA__IXY:
				return getIxy();
			case KinematicsPackage.INERTIA__IXZ:
				return getIxz();
			case KinematicsPackage.INERTIA__IYY:
				return getIyy();
			case KinematicsPackage.INERTIA__IYZ:
				return getIyz();
			case KinematicsPackage.INERTIA__IZZ:
				return getIzz();
		}
