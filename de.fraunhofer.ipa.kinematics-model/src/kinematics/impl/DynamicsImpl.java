 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.DynamicsImpl#getDamping <em>Damping</em>}</li>
 *   <li>{@link kinematics.impl.DynamicsImpl#getFriction <em>Friction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicsImpl extends MinimalEObjectImpl.Container implements Dynamics {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.DYNAMICS;
	}
	...
	public void setDamping(double newDamping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.DYNAMICS__DAMPING, oldDamping, damping, !oldDampingESet));
	}
	...
	public void unsetDamping() {
		...
		dampingESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.DYNAMICS__DAMPING, oldDamping, DAMPING_EDEFAULT, oldDampingESet));
	}
	...
	public void setFriction(double newFriction) {
		...
		frictionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.DYNAMICS__FRICTION, oldFriction, friction, !oldFrictionESet));
	}
	...
	public void unsetFriction() {
		...
		frictionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.DYNAMICS__FRICTION, oldFriction, FRICTION_EDEFAULT, oldFrictionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.DYNAMICS__DAMPING:
				return getDamping();
			case KinematicsPackage.DYNAMICS__FRICTION:
				return getFriction();
		}
