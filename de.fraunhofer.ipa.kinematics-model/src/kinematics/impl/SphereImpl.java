 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.SphereImpl#getRadius <em>Radius</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SphereImpl extends MinimalEObjectImpl.Container implements Sphere {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.SPHERE;
	}
	...
	public void setRadius(double newRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.SPHERE__RADIUS, oldRadius, radius, !oldRadiusESet));
	}
	...
	public void unsetRadius() {
		...
		radiusESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.SPHERE__RADIUS, oldRadius, RADIUS_EDEFAULT, oldRadiusESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.SPHERE__RADIUS:
				return getRadius();
		}
