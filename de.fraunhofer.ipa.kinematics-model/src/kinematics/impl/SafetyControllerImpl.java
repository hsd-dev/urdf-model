 ...
 * </p>
 * <ul>
 *   <li>{@link kinematics.impl.SafetyControllerImpl#getKPosition <em>KPosition</em>}</li>
 *   <li>{@link kinematics.impl.SafetyControllerImpl#getKVelocity <em>KVelocity</em>}</li>
 *   <li>{@link kinematics.impl.SafetyControllerImpl#getSoftLowerLimit <em>Soft Lower Limit</em>}</li>
 *   <li>{@link kinematics.impl.SafetyControllerImpl#getSoftUpperLimit <em>Soft Upper Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SafetyControllerImpl extends MinimalEObjectImpl.Container implements SafetyController {
	...
	protected EClass eStaticClass() {
		return KinematicsPackage.Literals.SAFETY_CONTROLLER;
	}
	...
	public void setKPosition(double newKPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.SAFETY_CONTROLLER__KPOSITION, oldKPosition, kPosition, !oldKPositionESet));
	}
	...
	public void unsetKPosition() {
		...
		kPositionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.SAFETY_CONTROLLER__KPOSITION, oldKPosition, KPOSITION_EDEFAULT, oldKPositionESet));
	}
	...
	public void setKVelocity(double newKVelocity) {
		...
		kVelocityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.SAFETY_CONTROLLER__KVELOCITY, oldKVelocity, kVelocity, !oldKVelocityESet));
	}
	...
	public void unsetKVelocity() {
		...
		kVelocityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.SAFETY_CONTROLLER__KVELOCITY, oldKVelocity, KVELOCITY_EDEFAULT, oldKVelocityESet));
	}
	...
	public void setSoftLowerLimit(double newSoftLowerLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, oldSoftLowerLimit, softLowerLimit, !oldSoftLowerLimitESet));
	}
	...
	public void unsetSoftLowerLimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, oldSoftLowerLimit, SOFT_LOWER_LIMIT_EDEFAULT, oldSoftLowerLimitESet));
	}
	...
	public void setSoftUpperLimit(double newSoftUpperLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, oldSoftUpperLimit, softUpperLimit, !oldSoftUpperLimitESet));
	}
	...
	public void unsetSoftUpperLimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, oldSoftUpperLimit, SOFT_UPPER_LIMIT_EDEFAULT, oldSoftUpperLimitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KinematicsPackage.SAFETY_CONTROLLER__KPOSITION:
				return getKPosition();
			case KinematicsPackage.SAFETY_CONTROLLER__KVELOCITY:
				return getKVelocity();
			case KinematicsPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT:
				return getSoftLowerLimit();
			case KinematicsPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT:
