...
public class LimitImpl extends MinimalEObjectImpl.Container implements Limit {
	...
	public void setEffort(double newEffort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.LIMIT__EFFORT, oldEffort, effort, !oldEffortESet));
	}
	...
	public void unsetEffort() {
		...
		effortESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.LIMIT__EFFORT, oldEffort, EFFORT_EDEFAULT, oldEffortESet));
	}
	...
	public void setLower(double newLower) {
		...
		lowerESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.LIMIT__LOWER, oldLower, lower, !oldLowerESet));
	}
	...
	public void unsetLower() {
		...
		lowerESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.LIMIT__LOWER, oldLower, LOWER_EDEFAULT, oldLowerESet));
	}
	...
	public void setUpper(double newUpper) {
		...
		upperESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.LIMIT__UPPER, oldUpper, upper, !oldUpperESet));
	}
	...
	public void unsetUpper() {
		...
		upperESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.LIMIT__UPPER, oldUpper, UPPER_EDEFAULT, oldUpperESet));
	}
	...
	public void setVelocity(double newVelocity) {
		...
		velocityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.LIMIT__VELOCITY, oldVelocity, velocity, !oldVelocityESet));
	}
	...
	public void unsetVelocity() {
		...
		velocityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KinematicsPackage.LIMIT__VELOCITY, oldVelocity, VELOCITY_EDEFAULT, oldVelocityESet));
	}
