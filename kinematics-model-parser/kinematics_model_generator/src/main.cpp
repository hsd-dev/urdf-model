...
int main(int argc, char* argv[]) {
    ...
    std::string group_name, base_link, end_link, virtual_child_link;
    ...
    desc.add_options()("help", "show help")
        ...
        ("group_name", po::value(&group_name), "Move group name")
        ("base_link", po::value(&base_link), "Base link name")
        ("end_link", po::value(&end_link), "End link name")
        ("virtual_child_link", po::value(&virtual_child_link), "End link name")
    ...
    mcp_generator.generateCollisionTable(include_default, include_always, never_trials,
    ...
    std::string child_link = virtual_child_link;
    bool success = mcp_generator.addVirtualJoints(child_link);
    ...
    success = mcp_generator.addPlanningGroup(group_name, base_link, end_link);
